...
+ (RTCIceCandidate *)candidateFromJSONDictionary:(NSDictionary *)dictionary {
    ...
    int mLineIndex = [num integerValue];
...
+ (NSData *)JSONDataForIceCandidates:(NSArray<RTCIceCandidate *> *)candidates{
    ...
    NSError *error = nil;
    NSData *data =
    [NSJSONSerialization dataWithJSONObject:jsonCandidates
...
+ (NSArray<RTCIceCandidate *> *)candidatesFromJSONArray:(NSArray *)array{
    NSMutableArray<RTCIceCandidate *> *candidates = [NSMutableArray arrayWithCapacity:array.count];
    for (NSDictionary *jsonCandidate in array) {
        RTCIceCandidate *candidate = [RTCIceCandidate candidateFromJSONDictionary:jsonCandidate];
